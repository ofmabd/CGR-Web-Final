...
import { Users, Target, Award, Briefcase, FileText, Shield, ChevronDown, ChevronUp } from "lucide-react";
  ...
  const services = [
    {
      ...
      icon: Users,
      overview: "Navigate complex employee relations challenges with expert guidance and strategic solutions that protect your organization while maintaining positive workplace relationships.",
      process: [
    ...
    },
    {
      ...
      icon: Target,
      overview: "Design and implement structured performance management frameworks that drive accountability, improve productivity, and align individual goals with organizational objectives.",
      process: [
    ...
    },
    {
      ...
      icon: Award,
      overview: "Equip supervisors with the skills, confidence, and tools they need to lead effectively, manage difficult conversations, and drive team performance.",
      process: [
    ...
    },
    {
      ...
      icon: Briefcase,
      overview: "Transform your organizational structure, culture, and processes to achieve strategic objectives and build sustainable competitive advantage.",
      process: [
    ...
    },
    {
      ...
      icon: FileText,
      overview: "Ensure your HR policies and practices comply with current regulations while supporting your business objectives and organizational culture.",
      process: [
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200">
              Strategic solutions designed to strengthen your organization, protect your interests, and drive sustainable performance.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700">
              Click on each service to learn more about our approach and deliverables
            </p>
          </div>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        ...
                        style={{
                          backgroundColor: isExpanded ? "var(--gold)" : "var(--purple)",
                  ...
                  {isExpanded && (
                    <div className="px-6 pb-6 space-y-6">
                      <div>
                        <h4 className="text-lg mb-2" style={{ color: "var(--navy)" }}>Overview</h4>
                        <p className="text-gray-700">{service.overview}</p>
                      </div>

                      <div>
                        <h4 className="text-lg mb-3" style={{ color: "var(--navy)" }}>Our Process</h4>
                      ...
                      <div>
                        <h4 className="text-lg mb-3" style={{ color: "var(--navy)" }}>Key Deliverables</h4>
                        <ul className="grid sm:grid-cols-2 gap-2">
                          {service.deliverables.map((deliverable, delIndex) => (
                            <li key={delIndex} className="flex items-start gap-2">
                              <span className="text-sm mt-1" style={{ color: "var(--gold)" }}>✓</span>
      ...
      <section className="py-20" style={{ backgroundColor: "var(--navy)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Shield size={64} className="mx-auto mb-6" style={{ color: "var(--gold)" }} />
          <h2 className="text-3xl md:text-4xl text-white mb-6" style={{ fontWeight: 700 }}>
            Ready to Strengthen Your HR Systems?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Schedule a consultation to discuss your specific needs and learn how we can support your organization.
          </p>
          <Link
            to="/contact"
