  ...
  const resources = [
    {
      ...
      category: "Templates",
      description:
        "Comprehensive template for creating or updating your employee handbook",
      type: "PDF",
      icon: FileText,
    },
    {
      ...
      category: "Templates",
      description:
        "Structured forms for conducting effective performance evaluations",
      type: "Word Doc",
      icon: FileText,
    },
    {
    ...
    },
    {
      ...
      category: "Templates",
      description:
        "Professional templates for documenting disciplinary actions",
      type: "Word Doc",
      icon: FileText,
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Start by preparing clear, specific examples of the behavior or performance issue. Schedule a private meeting, focus on facts rather than emotions, listen actively to the employee's perspective, and work together to develop an action plan with clear expectations and timeline.",
    },
    {
      question:
        "What documentation should I keep for employee relations issues?",
      answer:
        "Maintain detailed records of conversations, performance issues, disciplinary actions, and any incidents. Include dates, times, witnesses, specific behaviors observed, and actions taken. Keep all documentation confidential and stored securely.",
    },
    {
      question: "When should I involve HR in a workplace situation?",
      answer:
        "Contact HR for any situations involving potential policy violations, harassment or discrimination complaints, significant performance or conduct issues, accommodation requests, or when you're unsure how to proceed with an employee matter.",
    },
    {
      question: "How often should I conduct performance reviews?",
      answer:
        "Formal performance reviews should occur at least annually, but best practice includes quarterly check-ins and ongoing informal feedback. Regular conversations help prevent surprises and support continuous improvement.",
    },
    {
      question: "What are the key elements of a progressive discipline policy?",
      answer:
        "A typical progressive discipline process includes: verbal warning, written warning, final written warning, and termination. Each step should be documented, and the employee should have an opportunity to improve. Serious violations may warrant skipping steps.",
    },
    {
      question: "How do I ensure my hiring practices are legally compliant?",
      answer:
        "Use structured interviews with consistent questions, avoid prohibited inquiries (age, religion, marital status, etc.), document your selection rationale, conduct background checks with proper authorization, and ensure all job requirements are bona fide occupational qualifications.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8">
              Access essential tools, templates, and guidance to support your HR
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {categories.map((category) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      selectedCategory === category ? "var(--gold)" : "white",
                    color:
                      selectedCategory === category ? "var(--navy)" : "#4b5563",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              ...
              >
                <h3
                  className="text-xl mb-3 flex items-start gap-3"
                  style={{ color: "var(--navy)" }}
                >
                  <span
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Clear explanations of key HR policies and compliance
                requirements
              </p>
              <button
                className="text-sm inline-flex items-center gap-2 cursor-pointer"
      ...
      <section className="py-20" style={{ backgroundColor: "var(--navy)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Our HR consultants are available to provide guidance tailored to
